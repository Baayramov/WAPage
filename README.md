...
- Interface available in 62 languages — the interface language has no effect on the content inside chats
...
- Direct access to all photos, videos, links, files and locations from the media grid in profiles
- Going directly to the first message in the chat
- Being able to lock chats and read them with a password
...
- Written up to <b>30.000</b> code lines <br><br>
...
`Azerbaijan, Afrikaans, Albanian, Arabic, Bengali, Bulgarian, Catalan, Chinese (Simplified), Chinese (Traditional) Hong Kong, Chinese (Traditional) Taiwan, Croatian, Czech, Danish, Dutch, English, Estonian, Filipino, Finnish, French, German, Greek, Gujarati, Hebrew, Hindi, Hungarian, Indonesian, Irish, Italian, Japanese, Kannada, Kazakh, Korean, Lao, Latvian, Lithuanian, Macedonian, Malay, Malayalam, Marathi, Mongolian, Norwegian, Persian, Polish, Portuguese, Portuguese - Brazil, Punjabi, Romanian, Russian, Serbian - Cyrillic/Latin, Slovak, Slovenian, Spanish, Swahili, Swedish, Tamil, Telugu, Thai, Turkish, Ukrainian, Urdu - Pakistan, Uzbek, Vietnamese`
