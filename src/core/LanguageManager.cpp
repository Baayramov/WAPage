...
void LanguageManager::initTranslations()
{
    ...
    m_translations["Chinese"] = {
        ...
        {"import_new", "新聊天"}, {"zip_description", "选择您从 WhatsApp 导出的 ZIP 文件。"},
        {"select_zip", "选择 ZIP"}, {"change_zip", "更改"}, {"continue", "继续"},
        {"owner_question", "您叫什么名字？\n（在您的 WhatsApp 账户中显示的名字）"}, {"owner_placeholder", "例如：张三"},
        {"import_btn", "导入"}, {"back", "返回"}, {"loading_messages", "正在加载..."},
        {"select_zip_title", "选择 WhatsApp ZIP 文件"}, {"first_message", "第一条消息"}, {"delete_chat", "删除"}, {"search", "搜索..."}, {"search_tooltip", "搜索消息 (Ctrl+F)"},
        {"empty_chat_hint", "选择聊天"}, {"delete_confirm_title", "删除"},
        {"delete_confirm_text", "删除聊天？"}, {"no_results", "没有结果"},
        {"yes", "是"}, {"no", "否"}, {"cancel", "取消"}, {"language", "语言"}, {"select_language", "语言"}, {"profile_photo", "照片"},
        {"name_label", "名称"}, {"participants_label", "群成员"}, {"contact_name_placeholder", "联系人名称"}, {"image_files_filter", "图片文件 (*.jpg *.jpeg *.png *.webp)"},
        {"import_success", "%1 — 已导入 %2 条消息"}, {"conversation", "对话"},
        {"default_owner_name", "默认所有者名称"}, {"owner_name_placeholder", "您的名字"}, {"not_set", "未设置"}, {"default_label", "默认"},
        {"profile_library", "个人资料库"}, {"add_profile", "添加个人资料"}, {"profile_name_label", "名字:"}, {"add_btn", "添加"},
        {"optional", "(可选)"}, {"image_selected", "✓ 已选择"}, {"no_profiles_library", "还没有个人资料。点击 + 添加。"},
        {"profile_owner_conflict", "无法添加与所有者同名的个人资料"}, {"profile_exists", "此名称的个人资料已存在"},
        {"message_count_text", "条消息"},
        ...
        {"calendar_tooltip", "跳转到日期"},
        {"last_message", "最后消息"},
        {"settings", "设置"},
        {"auto_play_next_voice", "自动播放连续语音消息"},
