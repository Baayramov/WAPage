...
Rectangle {
    ...
    ColumnLayout {
        ...
        Item {
            ...
            Flickable {
                ...
                // Add spacing of 5px before Master Password Section
                Item { width: parent.width; height: 5 }
                
                // Master Password Section - for Locked Chats
                Column {
                    width: parent.width
                    spacing: 0
                    ...
                    Rectangle {
                        ...
                        Text {
                            ...
                            text: langManager.currentTranslations["locked_chats_password"] || "Kilidlənmiş Söhbətlərin Şifrəsi"
                            color: WAPageTheme.accent
                            font.family: WAPageTheme.fontFamily
                            font.pixelSize: WAPageTheme.fontSizeMicro
                            font.weight: Font.Medium
                    ...
                    Rectangle {
                        ...
                        Row {
                            ...
                            // Password display (blurred or "not set")
                            Text {
                                anchors.verticalCenter: parent.verticalCenter
                                width: parent.width - 100
                                text: mainWindow.hasMasterPassword() 
                                    ? "● ● ● ● ● ●"
                                    : (langManager.currentTranslations["no_password"] || "Şifrəniz yoxdur")
                                color: mainWindow.hasMasterPassword() 
                                    ? WAPageTheme.chatListText
                                    : WAPageTheme.chatListSubText
                                font.family: WAPageTheme.fontFamily
                                font.pixelSize: mainWindow.hasMasterPassword() ? 24 : WAPageTheme.fontSizeNormal
                                font.letterSpacing: mainWindow.hasMasterPassword() ? 8 : 0
                                elide: Text.ElideRight
                            }
                            
                            Item { Layout.fillWidth: true; width: 1 }
                            
                            // Change password button (only visible if password exists)
                            Button {
                                visible: mainWindow.hasMasterPassword()
                                anchors.verticalCenter: parent.verticalCenter
                                text: langManager.currentTranslations["change_password"] || "Şifrəyi dəyiş"
                ...
                // Add spacing before Profile Library
                Item { width: parent.width; height: 10 }
    ...
    Dialog {
        ...
        contentItem: Column {
            ...
            TextField {
                ...
                background: Rectangle {
                    radius: 8
                    color: WAPageTheme.dark ? "#2d2d2d" : WAPageTheme.panelBg
                    border.width: 1
                    border.color: WAPageTheme.divider
                }
    ...
    Dialog {
        ...
        implicitWidth: 400
        width: 400
        title: langManager.currentTranslations["change_password"] || "Şifrəni dəyiş"
        ...
        header: Label {
            ...
            visible: changePasswordDialog.title
        ...
        contentItem: Column {
            ...
            // Old password
            Text {
                text: langManager.currentTranslations["old_password"] || "Əvvəlki şifrə"
                color: WAPageTheme.chatListText
                font.family: WAPageTheme.fontFamily
                font.pixelSize: WAPageTheme.fontSizeNormal
            }
            ...
            TextField {
                ...
                background: Rectangle {
                    ...
                    border.color: oldPasswordInput.activeFocus ? WAPageTheme.accent : WAPageTheme.divider
                    border.width: 1
                }
            }
            ...
            // New password
            Text {
                text: langManager.currentTranslations["new_password"] || "Yeni şifrə"
                color: WAPageTheme.chatListText
                font.family: WAPageTheme.fontFamily
                font.pixelSize: WAPageTheme.fontSizeNormal
            }
            ...
            TextField {
                ...
                background: Rectangle {
                    radius: 6
                    color: WAPageTheme.searchBg
                    border.color: newPasswordInput.activeFocus ? WAPageTheme.accent : WAPageTheme.divider
                    border.width: 1
                }
            }
            ...
            Text {
                text: langManager.currentTranslations["confirm_password"] || "Yeni şifrəni təkrarla"
                color: WAPageTheme.chatListText
                font.family: WAPageTheme.fontFamily
                font.pixelSize: WAPageTheme.fontSizeNormal
            }
            ...
            TextField {
                ...
                background: Rectangle {
                    radius: 6
                    color: WAPageTheme.searchBg
                    border.color: confirmPasswordInput.activeFocus ? WAPageTheme.accent : WAPageTheme.divider
                    border.width: 1
                }

                Keys.onReturnPressed: {
                    if (oldPasswordInput.text.length === 6 && newPasswordInput.text.length === 6 && confirmPasswordInput.text.length === 6) {
            ...
            Row {
                ...
                Button {
                    ...
                    text: langManager.currentTranslations["change"] || "Dəyişdir"
                    enabled: oldPasswordInput.text.length === 6 && newPasswordInput.text.length === 6 && confirmPasswordInput.text.length === 6
                    onClicked: {
                        changePasswordErrorText.text = ""
                        
                        // Validate all fields are 6 digits
                        if (oldPasswordInput.text.length !== 6 || newPasswordInput.text.length !== 6 || confirmPasswordInput.text.length !== 6) {
                            changePasswordErrorText.text = langManager.currentTranslations["password_6_digits"] || "Şifrə 6 rəqəm olmalıdır"
                            return
                        }
                        
                        // Check old password first
                        if (!mainWindow.checkMasterPassword(oldPasswordInput.text)) {
                            changePasswordErrorText.text = langManager.currentTranslations["old_password_incorrect"] || "Əvvəlki şifrə düzgün deyil"
                            return
                        }
                        
                        // Check if new passwords match
                        if (newPasswordInput.text !== confirmPasswordInput.text) {
                            changePasswordErrorText.text = langManager.currentTranslations["passwords_dont_match"] || "Yeni şifrələr uyğun gəlmir"
                            return
                        }
                        
                        // Update password
                        mainWindow.setMasterPassword(newPasswordInput.text)
                        changePasswordDialog.close()
                        oldPasswordInput.text = ""
                        newPasswordInput.text = ""
                        confirmPasswordInput.text = ""
